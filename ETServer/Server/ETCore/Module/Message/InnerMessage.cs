...
/// </summary>
	...
	[Message(InnerOpcode.R2G_GetLoginKey2)]
	public partial class R2G_GetLoginKey2 : IActorRequest
	{
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.G2R_GetLoginKey2)]
	public partial class G2R_GetLoginKey2 : IActorResponse
	{
		public int RpcId { get; set; }
